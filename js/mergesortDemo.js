//Comments Dictionary
comments = {
    "av_c1": "Select the Array",
    "av_c2": "Sorting is done!",
    "av_c3": "This Array can't split further, now ready for merge",
    "av_c4": "Split the selected array in equal parts",
    "av_c5": "Select the left sub-array",
    "av_c6": "Select the right sub-array",
    "av_c7": "Sort and Merge selected arrays",
    "av_c8": "When one list becomes empty, copy all values from the remaining array into the sorted array",
    "av_c9": "Select the smallest value from starting of each list (except values that are already sorted)",
    "av_c10": "Select the smallest of the two values",
